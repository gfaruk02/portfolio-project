...
const Navbar = () => {
    ...
    const navItems = <> 
    <li className="hover:bg-sky-400 shadow-lg"><a href="#home">Home</a></li>
    <li className="hover:bg-sky-400 shadow-lg"><a href="#about">About Me</a></li>
    <li className="hover:bg-sky-400 shadow-lg"><a href="#projects">Projects</a></li>
    <li className="hover:bg-sky-400 shadow-lg"><a href="#contact">Contact</a></li>
    </>
    return (
        <div>
