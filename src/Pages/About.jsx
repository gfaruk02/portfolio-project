...
const About = () => {
    return (
        <div id="about" className="bg-blue-950 mb-10">
              <div className=" py-16 my-5 text-center bg-sky-700">
                <h1 className="text-5xl text-white"><a href="Resume-Golam-Faruk.pdf" download="Resume-Golam-Faruk.pdf"> Download Resume </a></h1>
            </div>
